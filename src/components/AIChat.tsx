...
export const AIChat: React.FC = () => {
    ...
    return (
        <>
            {/* Toggle Button */}
            {!isOpen && (
                <div className="fixed bottom-24 right-6 w-14 h-14 z-50">
                    <button
            ...
            {isOpen && (
                <motion.div 
                    ...
                    className={`fixed z-50 ${
                        isExpanded ? 'inset-4 md:inset-12' : 'bottom-20 right-6 w-[350px] md:w-[400px] h-[550px]'
                    }`}
                >
                    <div className="w-full h-full flex flex-col bg-white dark:bg-gray-800 rounded-2xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden backdrop-blur-xl">
                        ...
                        <div 
                            ...
                            className="h-16 bg-gradient-to-r from-purple-600 to-indigo-600 flex items-center justify-between px-5 text-white shrink-0 shadow-sm z-10 active:cursor-grabbing"
                        >
                            ...
                            <div className="flex items-center gap-2">
                                <button onClick={() => setIsExpanded(!isExpanded)} onPointerDown={(e) => e.stopPropagation()} className="p-1.5 hover:bg-white/20 rounded-lg transition-colors" title="Teljes képernyő">
                                    {isExpanded ? <Minimize2 size={16} /> : <Maximize2 size={16} />}
                                </button>
                                <button onClick={() => setIsOpen(false)} onPointerDown={(e) => e.stopPropagation()} className="p-1.5 hover:bg-white/20 rounded-lg transition-colors bg-white/10" title="Bezárás">
                                    <X size={16} />
                                </button>
                            </div>
                        </div>
                        ...
                        <div 
                            ...
                            className="flex-1 overflow-y-auto p-5 space-y-5 bg-gray-50/50 dark:bg-gray-900/50 scrollbar-thin relative scroll-smooth cursor-auto"
                        >
                        ...
                        <div 
                            onPointerDown={(e) => e.stopPropagation()} 
                            className="p-4 bg-white dark:bg-gray-800 border-t border-gray-100 dark:border-gray-700 shrink-0 cursor-auto"
                        >
