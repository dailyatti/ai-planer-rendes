...
const translations: Translations = {
  ...
  'nav.navigation': { en: 'Navigation', hu: 'Navigáció', ro: 'Navigare', sk: 'Navigácia', hr: 'Navigacija', de: 'Navigation', fr: 'Navigation', es: 'Navegación', it: 'Navigazione', pl: 'Nawigacja', cn: '导航', jp: 'ナビゲーション', pt: 'Navegação', tr: 'Navigasyon', ar: 'التنقل', ru: 'Навигация', hi: 'नेविगेशन', bn: 'নেভিগেশন', ur: 'نیویগیشن', th: 'การนำทาง', id: 'Navigasi' },
  ...
  // Common Terms
  'common.newTask': { en: 'New Task', hu: 'Új Feladat', ro: 'Sarcină Nouă', sk: 'Nová Úloha' },
  'common.addTask': { en: 'Add Task', hu: 'Feladat Hozzáadása', ro: 'Adaugă Sarcină', sk: 'Pridať Úlohu' },
  'common.completion': { en: 'Completion', hu: 'Teljesítettség', ro: 'Finalizare', sk: 'Dokončenie' },
  'common.tasks': { en: 'Tasks', hu: 'Feladatok', ro: 'Sarcini', sk: 'Úlohy' },
  'common.total': { en: 'Total', hu: 'Összesen', ro: 'Total', sk: 'Celkom' },

  // Daily & Weekly View Specifics
  'daily.addTask': { en: 'Add New Task', hu: 'Új Feladat Hozzáadása', ro: 'Adaugă Sarcină Nouă', sk: 'Pridať Novú Úlohu' },
  'daily.newTask': { en: 'New Task', hu: 'Új Feladat', ro: 'Sarcină Nouă', sk: 'Nová Úloha' },
  'daily.editTask': { en: 'Edit Task', hu: 'Feladat Szerkesztése', ro: 'Editează Sarcina', sk: 'Upraviť Úlohu' },
  'daily.taskTitle': { en: 'Task Title', hu: 'Feladat Címe', ro: 'Titlu Sarcină', sk: 'Názov Úlohy' },
  'daily.taskPlaceholder': { en: 'Enter task title...', hu: 'Feladat címe...', ro: 'Introduceți titlul sarcinii...', sk: 'Zadajte názov úlohy...' },
  'daily.descriptionPlaceholder': { en: 'Add a description...', hu: 'Leírás hozzáadása...', ro: 'Adăugați o descriere...', sk: 'Pridať popis...' },
  'daily.selectDate': { en: 'Select Date', hu: 'Dátum Kiválasztása', ro: 'Selectați Data', sk: 'Vyberte Dátum' },
  'daily.completion': { en: 'Completion Rate', hu: 'Teljesítési Arány', ro: 'Rată de Finalizare', sk: 'Miera Dokončenia' },
  'daily.tasks': { en: 'tasks', hu: 'feladat', ro: 'sarcini', sk: 'úlohy' },
  'daily.taskDescription': { en: 'Description', hu: 'Leírás', ro: 'Descriere', sk: 'Popis' },
  'daily.priority': { en: 'Priority', hu: 'Prioritás', ro: 'Prioritate', sk: 'Priorita' },
  'daily.lowPriority': { en: 'Low', hu: 'Alacsony', ro: 'Scăzută', sk: 'Nízka' },
  'daily.mediumPriority': { en: 'Medium', hu: 'Közepes', ro: 'Medie', sk: 'Stredná' },
  'daily.highPriority': { en: 'High', hu: 'Magas', ro: 'Ridicată', sk: 'Vysoká' },
  'common.update': { en: 'Update', hu: 'Frissítés', ro: 'Actualizare', sk: 'Aktualizovať' },
  'weekly.addTask': { en: 'Add Task', hu: 'Feladat Hozzáadása', ro: 'Adaugă Sarcină', sk: 'Pridať Úlohu' },

  // Integrations Modal
  'integrations.configure': { en: 'Configure', hu: 'Beállítás', ro: 'Configurare', sk: 'Konfigurovať' },
  'integrations.enterKey': { en: 'Enter API Key', hu: 'API Kulcs Megadása', ro: 'Introduceți Cheia API', sk: 'Zadajte API Kľúč' },
  'integrations.getKey': { en: 'Get Key', hu: 'Kulcs Beszerzése', ro: 'Obține Cheia', sk: 'Získať Kľúč' },
  'integrations.testConnection': { en: 'Test Connection', hu: 'Kapcsolat Tesztelése', ro: 'Testare Conexiune', sk: 'Testovať Pripojenie' },
  'integrations.connectionSuccess': { en: 'Connection Successful', hu: 'Sikeres Kapcsolódás', ro: 'Conexiune Reușită', sk: 'Pripojenie Úspešné' },
  'integrations.connectionFailed': { en: 'Connection Failed', hu: 'Sikertelen Kapcsolódás', ro: 'Conexiune Eșuată', sk: 'Pripojenie Zlyhalo' },
  'integrations.testing': { en: 'Testing connection...', hu: 'Kapcsolat tesztelése...', ro: 'Se testează conexiunea...', sk: 'Testovanie pripojenia...' },
  'integrations.connect': { en: 'Connect', hu: 'Kapcsolódás', ro: 'Conectare', sk: 'Pripojiť' },
  'integrations.disconnect': { en: 'Disconnect', hu: 'Szétkapcsolás', ro: 'Deconectare', sk: 'Odpojiť' },
  'integrations.connected': { en: 'Connected', hu: 'Csatlakoztatva', ro: 'Conectat', sk: 'Pripojené' },
  'integrations.available': { en: 'Available Integrations', hu: 'Elérhető Integrációk', ro: 'Integrări Disponibile', sk: 'Dostupné Integrácie' },
  'integrations.noIntegrations': { en: 'No Integrations Connected', hu: 'Nincsenek aktív integrációk', ro: 'Nicio Integrare Conectată', sk: 'Žiadne Pripojené Integrácie' },
  'integrations.connectAppsDesc': { en: 'Connect apps from the Available tab to start syncing your data.', hu: 'Csatlakoztasd alkalmazásaidat az "Elérhető" fülön az adatok szinkronizálásához.', ro: 'Conectați aplicații din fila Disponibile pentru a începe sincronizarea datelor.', sk: 'Pripojte aplikácie z karty Dostupné a začnite synchronizovať svoje údaje.' },
  'integrations.syncSettings': { en: 'Sync Settings', hu: 'Szinkronizálás', ro: 'Setări Sincronizare', sk: 'Nastavenia Synchronizácie' },
  'integrations.autoSyncInterval': { en: 'Auto-sync interval', hu: 'Automatikus frissítés', ro: 'Interval Sincronizare Automată', sk: 'Interval Automatickej Synchronizácie' },
  'integrations.syncFrequency': { en: 'How often to sync', hu: 'Gyakoriság beállítása', ro: 'Cât de des să se sincronizeze', sk: 'Ako často synchronizovať' },
  'integrations.every15Mins': { en: 'Every 15 mins', hu: '15 percenként', ro: 'La fiecare 15 min', sk: 'Každých 15 minút' },
  'integrations.everyHour': { en: 'Every hour', hu: 'Óránként', ro: 'La fiecare oră', sk: 'Každú hodinu' },
  'integrations.manualOnly': { en: 'Manual only', hu: 'Manuális', ro: 'Doar manual', sk: 'Len manuálne' },

  // Settings
  'settings.timeZone': { en: 'Time Zone', hu: 'Időzóna', ro: 'Fus Orar', sk: 'Časové Pásmo' },
  'settings.dateFormat': { en: 'Date Format', hu: 'Dátum Formátum', ro: 'Format Dată', sk: 'Formát Dátumu' },
  'settings.dateFormatUS': { en: 'MM/DD/YYYY (US Format)', hu: 'HH/NN/ÉÉÉÉ (Amerikai)', ro: 'LL/ZZ/AAAA (SUA)', sk: 'MM/DD/RRRR (USA)' },
  'settings.dateFormatEU': { en: 'DD/MM/YYYY (European Format)', hu: 'NN/HH/ÉÉÉÉ (Európai)', ro: 'ZZ/LL/AAAA (Europa)', sk: 'DD/MM/RRRR (Európa)' },
  'settings.dateFormatISO': { en: 'YYYY-MM-DD (ISO Format)', hu: 'ÉÉÉÉ-HH-NN (ISO)', ro: 'AAAA-LL-ZZ (ISO)', sk: 'RRRR-MM-DD (ISO)' },
  'settings.autoSaveDesc': { en: 'Automatically save changes', hu: 'Változások automatikus mentése', ro: 'Salvare automată modificări', sk: 'Automaticky ukladať zmeny' },
